...
import { Building2, Hash, Layers, Users } from "lucide-react";

const SECTORES = [
  "Tecnología", "Salud", "Finanzas", "Retail",
  "Manufactura", "Educación", "Gobierno", "Servicios", "Otro",
];

// ✅ Alineado con backend: MICRO | PYME | GRANDE
const TAMANOS = [
  { value: "MICRO", label: "Microempresa (1–10 empleados)" },
  { value: "PYME",  label: "PYME (11–200 empleados)" },
...
export default function FormularioEmpresa({ onSubmit, loading }) {
  ...
  const validate = () => {
    ...
    if (!form.nit.trim()) e.nit = "El NIT es obligatorio";
      ...
      e.nit = "Formato NIT inválido (ej: 900123456)";
    ...
    <form onSubmit={handleSubmit} className="space-y-5" noValidate>
      <div>
        ...
        <div className="relative">
          ...
          <input id="nombre" name="nombre" type="text" value={form.nombre}
            onChange={handleChange} placeholder="Empresa S.A.S."
      ...
      <div>
        ...
        <div className="relative">
          ...
          <input id="nit" name="nit" type="text" value={form.nit}
            onChange={handleChange} placeholder="900123456"
      ...
      <div>
        <label className="label" htmlFor="tamano">Tamaño de la empresa</label>
        <div className="relative">
          <Users className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400" />
          <select id="tamano" name="tamano" value={form.tamano} onChange={handleChange}
